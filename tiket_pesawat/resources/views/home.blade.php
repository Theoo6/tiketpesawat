...
@section('content')
    ...
    <head>
        ...
        <style>
            ...
            .bg-image {
                background-image: url('img/bandara soehatta.jpg');
                ...
                height: 100vh;
                /* Mengatur tinggi elemen (misal, seukuran layar) */
                position: relative;
                /* Agar overlay bisa ditempatkan di atas gambar */
            }
            ...
            .bg-overlay {
                ...
                z-index: 1;
                /* Makes sure the overlay is above the background but below the content */
            }

            .bg-gambar {
                background-image: url('img/soehatta.jpg');
                /* Ganti dengan path gambar Anda */
                background-size: cover;
                /* Agar gambar menutupi seluruh elemen */
                background-position: center;
            ...
            .container {
                position: relative;
                z-index: 2;
                /* Ensures the text content appears above the overlay */
            }
            ...
            .container {
                ...
                position: relative;
                /* Agar elemen anak (teks) tetap berada di atas overlay */
                z-index: 2;
                /* Menempatkan container di atas overlay */
            }
            ...
            h1 {
                margin: 0;
                color: white;
                /* Membuat teks menjadi putih agar kontras dengan latar belakang gelap */
            }
            ...
            .card {
                ...
                /* Transisi halus saat card diperbesar */
            }

            .card:hover {
                transform: scale(1.05);
                /* Membuat card sedikit lebih besar saat hover */
                box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);
                /* Menambahkan efek shadow yang lebih besar saat hover */
            }
        </style>
    </head>
    ...
    <body>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-lg"> <!-- Menambahkan shadow-lg pada card -->
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Garuda Indonesia melayani penerbangan ke berbagai destinasi internasional
                                yaitu :</p>
                            <ul>
        ...
        <div class="bg-gambar mt-5">
            <div class="bg-overlay"></div>
            <div class="container text-center py-5 d-flex align-items-center justify-content-center">
                <div>
                    <h1 class="text-white">Hubungi Kami Di bawah Ini</h1>
                    <a href="{{ route('contact') }}" class="btn btn-primary mt-4">Kontak →</a>
                </div>
            </div>
        </div>

        <!-- Footer -->
        <footer class="bg-dark text-white text-center d-flex align-items-center justify-content-center py-3">
